...
import com.idealista.android.challenge.detail.ui.DetailActivity
...
class ListActivity : AppCompatActivity(), ListView {
    ...
    override fun render(list: ListModel) {
        ...
        listAdapter.listener(object : ListAdapter.AdListener {
            ...
            override fun onFavAdded(ad: AdModel) {
                ListAssembler.presenter.onFavClicked(ad)
            }
        })
    }

    override fun navigateToDetail(adModel: AdModel) {
        val intent = Intent(this, DetailActivity::class.java).apply {
            putExtra("URL", adModel.detail)
        }
